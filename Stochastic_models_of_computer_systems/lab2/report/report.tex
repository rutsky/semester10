...
\subsection{Идентификация времени поступления заявок}
...
{\label{fig:graph:lc0-Tc-sigma}\includegraphics[height=7cm]{../../data/K_of_sigma.pdf}}
  \quad
  \subfloat[Зависимость относительной погрешности оценивания $|T_c|$ от $\sigma_c$.]%
{\label{fig:graph:lc0-Tc-sigma-c}\includegraphics[height=7cm]{../../data/K_of_sigma_c.pdf}}
