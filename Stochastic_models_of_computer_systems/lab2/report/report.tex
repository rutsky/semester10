...
$$T(X_{k+n+2}) = 
    ...
    \mathbf{P}\big(
      \mathcal{N}(0, \widehat{\sigma} \Delta t) = 
...
поступающих заявок}
Рассмотрим разности наблюдаемой величины в момент поступления заявки и 
...
каждое их них представляет собой наблюдение линейной комбинации двух нормально 
распределённых случайных величин с параметрами, которые необходимо оценить.
Применим EM-метод для оценки неизвестных параметров.
